...
export class AlertDetailPanel {
    private static current: AlertDetailPanel | undefined;
    private readonly panel: vscode.WebviewPanel;

    static show(alert: Alert, extensionUri: vscode.Uri): void {
    ...
    private update(alert: Alert): void {
...
// ── HTML builder ──────────────────────────────────────────────────────────────
function buildHTML(a: Alert): string {
